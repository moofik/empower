...
use Moofik\LaravelFilters\Filter\SearchFilter;
...
class User extends Authenticatable
{
    ...
    public const USER_ROLE_SHOP = 'workshop';
    public const USER_ROLE_USER = 'user';
    public const USER_ROLE_GUEST = 'guest';
    public const USER_ROLE_MODERATOR = 'moderator';

    public const RELATION_SHOP_BRAND = 'shopBrands';
    public const RELATION_SHOP_PAYMENT_OPTIONS = 'shopPaymentOptions';
    public const RELATION_SHOP_SERVICES = 'shopServices';
    public const RELATION_SHOP_SCHEDULE = 'shopSchedule';
    public const RELATION_SHOP_SETTINGS = 'shopSettings';
    public const RELATION_SHOP_WARRANTY = 'shopWarranty';
    public const RELATION_SHOP_SPARE_PARTS = 'shopSpareParts';
    public const RELATION_SHOP_LOGO = 'shopLogo';
    public const RELATION_SHOP_CERTIFICATES = 'shopCertificates';
    public const RELATION_OFFERS = 'offers';

    public const RELATIONS = [
        self::RELATION_SHOP_BRAND,
        self::RELATION_SHOP_PAYMENT_OPTIONS,
        self::RELATION_SHOP_SERVICES,
        self::RELATION_SHOP_SCHEDULE,
        self::RELATION_SHOP_SETTINGS,
        self::RELATION_SHOP_WARRANTY,
        self::RELATION_SHOP_SPARE_PARTS,
    ...
    protected $filters = [
        [SearchFilter::class, 'id', SearchFilterPartial::class]
    ];
    ...
    {
        return $this->hasRole([self::USER_ROLE_SHOP]);
    }
