 ...
 * @property Collection|ItemRequestOffer[] $repairRequestOffers
...
class RepairRequest extends Model
{
    ...
    {
        return $this->hasMany(ItemRequestViewer::class, 'repair_request_id', 'id');
    }

    public function repairRequestOffers(): HasMany
    {
        return $this->hasMany(ItemRequestOffer::class, 'repair_request_id', 'id');
    }
}
