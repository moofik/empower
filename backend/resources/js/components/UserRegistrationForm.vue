<template>
    <section class="registration-form animated fadeInDown">
        <div class="registration-container">
            <h1><span class="text-deep-orange">{{ $t('Sign Up') }}</span></h1>
    ...
    export default {
        ...
        methods: {
            async registerUser() {
                ...
                try {
                    await this.errorAwareStoreDispatch(Actions.AUTH_REGISTER_USER, registerUserDto);
                    this.errors = null;
                ...
                if (this.autologin) {
                    ...
                    try {
                        await this.errorAwareStoreDispatch(Actions.AUTH_LOGIN, {username: this.email, password: this.password});
                        this.$emit('logged-in');
                    } catch (e) {
                        console.log(e);
                    }
