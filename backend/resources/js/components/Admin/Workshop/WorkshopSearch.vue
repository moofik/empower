...
<script>
    ...
    export default {
        ...
        computed: {
            queryString() {
                ...
                if (this.debouncedInput !== '') {
                    query += `&email,full_name,workshopSettings.workshop_name,workshopSettings.city,workshopSettings.workshop_phone[LIKE]=${this.debouncedInput}`;
                }
            ...
            queryObject() {
                ...
                if (this.debouncedInput !== '') {
                    ...
                    result['email,full_name,workshopSettings.workshop_name,workshopSettings.city,workshopSettings.workshop_phone[LIKE]'] = this.debouncedInput
                }
        ...
        created() {
            ...
            const debouncedInput = (new URLSearchParams(window.location.search)).get('email,full_name,workshopSettings.workshop_name,workshopSettings.city,workshopSettings.workshop_phone[LIKE]');
