...
<script>
    ...
    export default {
        ...
        computed: {
            queryString() {
                ...
                if (this.debouncedInput !== '') {
                    query += `&name,phone,email,city,workshopMake.name,workshopService.name[LIKE]=${this.debouncedInput}`;
                }
            ...
            queryObject() {
                ...
                if (this.debouncedInput !== '') {
                    ...
                    result['name,phone,email,city,workshopMake.name,workshopService.name[LIKE]'] = this.debouncedInput
                }
        ...
        created() {
            ...
            const debouncedInput = (new URLSearchParams(window.location.search)).get('name,phone,email,city,workshopMake.name,workshopService.name[LIKE]');
